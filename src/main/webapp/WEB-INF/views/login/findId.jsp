	...
	<div class="find_id_container">
		...
		<form class="findFrm">
			...
			<div class="phone_div">
				...
				<div class="phone_code">
					...
					<div class="code_div">
						...
						<input type="text" id="code" name="code" value="" placeholder="인증번호 숫자 6자리" maxlength="6"/>
						</div>
						<button class="code_btn">재발송</button>
						<p id="countdown" class="count_down"></p>
					</div>
				</div>
				<button class="submit_btn" id="phone_confirm_btn" type="submit" disabled="" radius="4">
					<span class="get_number">인증번호 받기</span>
				</button>
				<button class="submit_btn" id="final_id_btn" type="submit" disabled="" radius="4">
			...
			$("#phone_confirm_btn").click((e) => {
				const checkType = "IP";
				const $code_btn = $("phone_confirm_btn");
				const $submit_btn = $("final_id_btn");
