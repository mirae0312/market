...
<div class="csPage">
    ...
    <div class="csPage-section">
        <div class="csPage-aticle">
            <h2 class="cs-title">상품제안</h2>
        </div>
        <ul class="list-title">
        	<li><p>마켓갈래에서 추가적으로 판매되면 좋을 상품을 제안해주세요.</p></li>
        	<li><p>고객님의 의견을 발 빠르게 반영하여 더욱 편리한 마켓갈래가 되겠습니다.</p></li>
        	<li><p>주의)알콜 제품은 법령상 온라인 판매가 불가하오니, 이 점 참고하여 작성부탁드립니다.</p></li>
        	<li><p>담당MD가 제안해주신 의견을 실시간으로 모니터링할 예정이나, 별도 답변 안내는 되지 않음을 양해부탁드립니다.</p></li>
        </ul>
        <!-- 게시판 -->
        <div class="csBoard">
            <table class="csTable">
            ...
            <div class="write-section">
                    <div class="writeBox">
                        <button type="button" onclick="location.href='${pageContext.request.contextPath}/service/enroll/productProposal'">글쓰기</button>
                    </div>
            </div>
