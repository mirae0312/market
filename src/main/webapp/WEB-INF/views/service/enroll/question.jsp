...
<%@ page import="com.project.market.security.model.vo.MemberEntity" %>
...
<meta id="_csrf_header" name="_csrf_header" content="${_csrf.headerName}" />
 ...
 <style>
        ...
        .board-write table input[type=text].writeTitle{
        	width: 100%;
        }
        .board-write table input[type=text].read_only{
        	color: #949296;
        	pointer-events : none;
                ...
                <table class="writeTable">
                    <tbody>
                        <tr>
                            <th>제목</th>
                            <td>
                                <select name="questionCategory" id="">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text">
                                <button class="board-btn orderBtn" onclick="order_open()">주문번호</button>
                                <div>
                                	<table>
                        ...
                        <tr>
                            <th>이메일</th>
                            <td>
                                <input type="text" name="email" value="${loginMember.email}" class="read_only" readonly>
                        ...
                        <tr>
                            <th>문자메세지</th>
                            <td>
                                <input type="text" name="phone" value="${loginMember.phone}" class="read_only" readonly>
